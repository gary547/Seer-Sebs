...
expect_allowed "$worker_url" "SELECT 1 FROM pipeline_stage_output_chunks LIMIT 1"
...
expect_denied "$api_url" "SELECT 1 FROM pipeline_stage_output_chunks LIMIT 1"
expect_denied "$dispatcher_url" "SELECT 1 FROM pipeline_stage_output_chunks LIMIT 1"
expect_denied "$events_url" "SELECT 1 FROM pipeline_stage_output_chunks LIMIT 1"
