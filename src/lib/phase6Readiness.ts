// Phase 6 readiness classifier — client mirror of
// supabase/functions/_shared/phase6-readiness.ts.
// KEEP IN SYNC with that file (Deno edge functions cannot import from src/).
